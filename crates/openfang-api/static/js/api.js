// EphItUpStudio API Client — Fetch wrapper, WebSocket manager, auth injection, toast notifications
'use strict';

// ── Toast Notification System ──
var EphToast = (function() {
  var _container = null;
  var _toastId = 0;
      ...
      _ws.onclose = function(e) {
        ...
        if (_wsAgentId && _reconnectAttempts < MAX_RECONNECT && e.code !== 1000) {
          ...
          if (_reconnectAttempts === 1) {
            EphToast.warn('Connection lost, reconnecting...');
          }
        ...
        if (_wsAgentId && _reconnectAttempts >= MAX_RECONNECT) {
          setConnectionState('disconnected');
          EphToast.error('Connection lost — switched to HTTP mode', 0);
        }
